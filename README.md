...
📁 Input Files
Each day's folder includes an input subdirectory:

test.txt: This file contains the sample input provided by the challenge creators. Use this to test and verify your solution against known examples.

actual.txt: This file contains the real, larger input required to get the final answer for the day's challenge.